...
from Syntaxer.reverse_syntax_consts import TOKEN_TYPES, KEYWORDS, VALUE_TYPES
...
SEMANTIC_TYPE_TO_VALUE_TYPE: dict[SEMANTIC_TYPE, VALUE_TYPES] = {
    SEMANTIC_TYPE.INT:   VALUE_TYPES.INT,
    SEMANTIC_TYPE.FLOAT: VALUE_TYPES.FLOAT,
    SEMANTIC_TYPE.BOOL:  VALUE_TYPES.BOOL
}
